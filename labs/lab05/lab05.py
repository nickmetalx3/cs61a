...
def make_pytunes(username):
    ...
    return tree(username,
                [tree('pop', [tree('justin bieber', [tree('single', [tree('what do you mean?')])]), tree('2015 pop mashup')]), 
...
def add_song(t, song, category):
    ...
    if root(t) == category:
        ...
        stems = [add_song(b, song, category) for b in branches(t)]
        return tree(root(t), stems)
